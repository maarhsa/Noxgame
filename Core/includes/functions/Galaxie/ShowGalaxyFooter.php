...
function ShowGalaxyFooter ( $Galaxy, $System,  $CurrentMIP, $CurrentRC, $CurrentSP) {
	...
	// $Result .= "<th colspan=7>";
	// $Result .= "<a href=". INDEX_BASE ."flotte&galaxy=".$Galaxy."&amp;system=".$System."&amp;planet=16;planettype=1&amp;target_mission=15>". $lang['gf_unknowsp'] ."</a>";
	// $Result .= "</th>";
	// $Result .= "</tr>";
	...
	$Result .= "<td class=c colspan=6><span id=\"slots\">". $maxfleet_count ."</span>/". $fleetmax ." ". $lang['gf_fleetslt'] ."</td>";
