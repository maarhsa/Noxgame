...
function MissionCaseAttack ($FleetRow)
{
    ...
    if ($FleetRow['fleet_start_time'] <= time()) {
	       ...
	       //Code D'Avishka
		//Le but est de savoir si le nombre d'attaque (par joueur actif et par jour) autorisé a été atteint
		/*if($FleetRow['fleet_target_owner'] != $FleetRow['fleet_owner'])
		{
			if($FleetRow['fleet_owner']==69 
			or $FleetRow['fleet_owner']==79 
			or $FleetRow['fleet_owner']==81 
			or $FleetRow['fleet_owner']==82 
			or $FleetRow['fleet_owner']==83 
			or $FleetRow['fleet_owner']==95 
			or $FleetRow['fleet_owner']==96 
			or $FleetRow['fleet_owner']==113
			or $FleetRow['fleet_owner']==133
			or $FleetRow['fleet_owner']==144)
			{
				if($FleetRow['fleet_target_owner']==38)
				{
				 // on ne fait rien
				}
				else
			...
			elseif($FleetRow['fleet_owner']==38)
			{
				if($FleetRow['fleet_target_owner']==69 
				or $FleetRow['fleet_target_owner']==79 
				or $FleetRow['fleet_target_owner']==81 
				or $FleetRow['fleet_target_owner']==82 
				or $FleetRow['fleet_target_owner']==83 
				or $FleetRow['fleet_target_owner']==95 
				or $FleetRow['fleet_target_owner']==96 
				or $FleetRow['fleet_target_owner']==113
				or $FleetRow['fleet_target_owner']==133
				or $FleetRow['fleet_target_owner']==144)
				{
					// on fait rien
				}
				else
