...
function FleetBuildListBox ($CurrentUser,&$CurrentPlanet ) {
	...
	$calculetemps = pretty_time($QueueTime - $CurrentPlanet['b_hangar']);
	...
	$text .= parsetemplate(gettemplate('Vaisseau/buildings_script_fleet'), $parse);
