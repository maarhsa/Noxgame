...
function is_Opera(){
  ...
  $user_agent       = $_SERVER['HTTP_USER_AGENT'];
	...
	if(mb_eregi('Opera mini',$user_agent))
	{
		$mobile_opera = true;
	}
return $mobile_opera;
...
function is_mobile(){
  ...
  switch(true){
    ...
    case (mb_eregi('ipod',$user_agent)||mb_eregi('iphone',$user_agent));
      $mobile_browser = true;
    break;
 
    case (mb_eregi('Mobile Safari',$user_agent));
      $mobile_browser = true;
    break;
 
    // case (mb_eregi('opera mini',$user_agent));
      // $mobile_browser = true;
    // break;
    ...
    case (mb_eregi('blackberry',$user_agent));
      $mobile_browser = true;
    break;
