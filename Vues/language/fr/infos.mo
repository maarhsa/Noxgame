...
$lang['info'][5]['name']         = "Centrale &eacute;lectrique a Hydrog&eacute;ne";
$lang['info'][5]['description']  = "Plus le niveau de votre centrale est &eacute;lev&eacute;, plus vous produirez d'&eacute;nergie. Attention, votre centrale &eacute;lectrique a Hydrog&eacute;ne consommera de l hydrog&eacute;ne !";

// ----------------------------------------------------------------------------------------------------------
// Batiments Généraux!
$lang['info'][6]['name']         = "Usine de Robots";
$lang['info'][6]['description']  = "Le d&eacute;veloppement de ce b&acirc;timent permet d'am&eacute;liorer la vitesse de construction des b&acirc;timents, vaisseaux, d&eacute;fenses et recherches.";
$lang['info'][7]['name']         = "Usine de Nanites";
$lang['info'][7]['description']  = "Une am&eacute;lioration deux fois plus puissante de l'usine de robot qui divise en deux le temps de construction des b&acirc;timents ainsi que des vaisseaux &agrave; chaque niveau.";
$lang['info'][8]['name']         = "Centre spatial";
$lang['info'][8]['description']  = "L'investissement dans un centre spatial plus d&eacute;velopp&eacute; vous permettra de construire des vaisseaux et de la d&eacute;fense plus cons&eacute;quente.";
$lang['info'][9]['name']         = "Silo de Metal";
$lang['info'][9]['description']  = "Votre silo a une capacit&eacute; r&eacute;duite, investissez dans un silo plus grand pour stocker d'avantage de metal. Attention si votre silo est plein, la production de metal s'arr&ecirc;te instantan&eacute;ment !";
$lang['info'][10]['name']         = "Silo de cristal";
$lang['info'][10]['description']  = "Votre silo a une capacit&eacute; r&eacute;duite, investissez dans un silo plus grand pour stocker d'avantage de cristal. Attention si votre silo est plein, la production de cristal s'arr&ecirc;te instantan&eacute;ment !";
$lang['info'][11]['name']         = "Entrep&ocirc;t de deuterium";
$lang['info'][11]['description']  = "Votre entrep&ocirc;t a une capacit&eacute; r&eacute;duite, investissez dans un entrep&ocirc;t plus grand pour stocker d'avantage de Deuterium. Attention si votre entrep&ocirc;t est plein, la production de deuterium s'arr&ecirc;te instantan&eacute;ment !";
$lang['info'][12]['name']         = "Centre de recherche";
$lang['info'][12]['description']  = "Le centre de recherche est n&eacute;cessaire pour d&eacute;velopper de nouvelles technologies. En construisant les niveaux sup&eacute;rieurs de ce b&acirc;timent vous faites acc&eacute;l&eacute;rer le temps de construction de vos technologies.";
$lang['info'][14]['name']         = "Acc&eacute;l&eacute;rateur de Particule";
$lang['info'][14]['description']  = "Suite &#224; vos d&eacute;couvertes sur les nanites, vos scientifiques, avec la volont&eacute; de pousser leurs recherches toujours plus loin, ont &eacute;labor&eacute;s l'acc&eacute;l&eacute;rateur de particules permettant d'effectuer vos recherches dans un d&eacute;lai moins important.";
$lang['info'][15]['name']         = "Centre de défense";
$lang['info'][15]['description']  = "Le centre de défense est primordiale pour votre population , plus ce centre sera élevé , plus votre population auras confiance en vous . il permet de construire de nouvelles défenses.";
$lang['info'][13]['name']         = "Terraformeur";
$lang['info'][13]['description']  = "Le d&eacute;veloppement continu des plan&egrave;tes a soulev&eacute; rapidement la question de la limitation de l'espace vital. Les m&eacute;thodes de construction souterraine et en surface se sont aver&eacute;es insuffisantes. Un petit groupe compos&eacute; de physiciens en &eacute;nergie et d'ing&eacute;nieurs en technologie de nanites a finalement trouv&eacute; la solution: la terraformation.<br>Le terraformeur peut rendre habitable des contr&eacute;es entieres ou m&ecirc;me des continents en utilisant de gigantesques quantit&eacute;s d'&eacute;nergie. Des nanites specialement d&eacute;velopp&eacute;es, assurant une qualit&eacute; constante du sol, sont produites continuellement dans ce bâtiment.<br><br>Une fois construit, le terraformeur ne peut &ecirc;tre d&eacute;truit.";
// ----------------------------------------------------------------------------------------------------------
// Laboratoire !
...
$lang['info'][125]['name']        = "Technologie Occultation";
$lang['info'][125]['description'] = "Fusion entre le plasma et le ions, elle permettrait dis-t-on de convertir de la mati&egrave;re en antimati&egrave;re ce qui aboutirait à une occultation partielle de b&acirc;timents ou vaisseaux.";
$lang['info'][126]['name']        = "Technologie Pl&eacute;nitude";
$lang['info'][126]['description'] = "Permet d augmenter la capacit&eacute; de stockage  des hangars";
$lang['info'][127]['name']        = "Technologie Solaris";
$lang['info'][127]['description']  = "A la recherche de toujours plus d'&eacute;nergie, vos scientifiques ont trouv&eacute;s le moyen de capter l'&eacute;nergie des &eacute;ruptions solaires. Ce proc&eacute;d&eacute; permettrait d'alimenter le canon le plus dévastateur de notre &eacute;re.";
$lang['info'][128]['name']        = "Expansion";
$lang['info'][128]['description'] = "Le terraformage de certaines plan&egrave;tes n'&eacute;tant pas assez rentable pour les grandes entreprises, des scientifiques ont mis au point une am&eacute;lioration, en y ajoutant des expansions.";
$lang['info'][129]['name']        = "Teleportation";
$lang['info'][129]['description'] = "les Scientifiques ont travaill&eacute;s durant des ann&eacute;es dans le secret , pour decouvrir un moyen de d&eacute;placement instantan&eacute; des ressources.";
...
// ----------------------------------------------------------------------------------------------------------
// Flotte !
$lang['info'][202]['name']        = "Cargo";
$lang['info'][202]['description'] = "Les Cargos ont &agrave; peu pr&egrave;s la m&ecirc;me taille que les chasseurs, mais n'ont pas de propulsion puissante ou d'armes, afin d'avoir plus de place pour le fret. Le vaisseau de type Cargo peut transporter 5.000 unit&eacute;s de ressources. Le Transporteur peut transporter cinq fois plus de fret. En m&ecirc;me temps sa protection et sa propulsion sont plus puissantes. En raison de leur puissance de tir limit&eacute;e, les vaisseaux de type Cargo sont souvent escort&eacute;s par d'autres vaisseaux.<br><br>Le d&eacute;veloppement du r&eacute;acteur &agrave; impulsion au niveau 5 permet de r&eacute;&eacute;quiper le Cargo avec ce type de r&eacute;acteurs, acc&eacute;l&eacute;rant alors sensiblement ce vaisseau.";
$lang['info'][203]['name']        = "Transporteur";
$lang['info'][203]['description'] = "Ce vaisseau n'a gu&egrave;re d'armes ou d'autres technologies &agrave; bord. Il est donc pr&eacute;f&eacute;rable de lui fournir une escorte qui lui permet de profiter de toute sa capacit&eacute; de fret. Avec son r&eacute;acteur de combustion de haute performance, le transporteur sert pour transporter rapidement des ressources entre les plan&egrave;tes et bien s&ucirc;r il accompagne les flottes durant leurs attaques sur d'autres plan&egrave;tes pour pouvoir conqu&eacute;rir le nombre maximal de ressources.";
$lang['info'][216]['name']        = "Archonte";
$lang['info'][216]['description'] = "L'Archonte est n&eacute; gr&acirc;ce à la technologie Pl&eacute;nitude et la modification du Transporteur, il transporte 3 fois plus mais consomme 3 fois plus.";
...
$lang['info'][206]['name']        = "Intercepteur";
$lang['info'][206]['description'] = "Le d&eacute;veloppement des lasers lourds et des canons d'ions sonn&egrave;rent le glas de l'&eacute;poque des chasseurs. Malgr&eacute; de nombreuses modifications, la puissance des Armements et de la protection ne purent &ecirc;tre assez am&eacute;lior&eacute;es pour pouvoir battre ces canons de d&eacute;fense. Il fut donc d&eacute;cid&eacute; de construire une nouvelle classe de vaisseaux avec plus de protection et de puissance de tir. L'Intercepteur &eacute;tait cr&eacute;&eacute;. Les Intercepteurs ont une protection presque trois fois plus grande que celle des chasseurs lourds et leur puissance de tir est plus que deux fois plus puissante. De plus, ils sont tr&egrave;s rapides. Il n'y a pas d'arme plus puissante contre la d&eacute;fense moyenne. Les Intercepteur ont domin&eacute; l'espace pendant presque un si&egrave;cle. L'apparition de l'artillerie &eacute;lectromagn&eacute;tique et des lanceurs de plasma a mis fin &agrave; leur domination. Pourtant ils servent encore souvent dans les batailles contre les unit&eacute;s de chasseurs.";
$lang['info'][207]['name']        = "Fr&eacute;gate";
$lang['info'][207]['description'] = "Les Fr&eacute;gates jouent un r&ocirc;le central dans les flottes. Avec leur artillerie lourde, leur vitesse consid&eacute;rable et la grande capacit&eacute; de fret, ils sont des adversaires respectables.";
$lang['info'][208]['name']        = "Colonisateur";
...
$lang['info'][409]['name']        = "canon catalyseur";
$lang['info'][409]['description'] = "Le canon catalyseur capte l'&eacute;nergie des &eacute;ruptions solaires pour acc&eacute;l&eacute;rer l'&eacute;negie emmagasin&eacute;e pour ensuite tirer des projectiles d'&eacute;nergie pure.";
// ----------------------------------------------------------------------------------------------------------
// Missiles !
...
$lang['info'][601]['description'] = "Le g&eacute;ologue est un expert reconnu en astromin&eacute;ralogie et en astrocristallographie. Avec son &eacute;quipe d'experts en m&eacute;tallurgie et d'ing&eacute;nieurs chimiste, il assiste les gouvernements interplan&eacute;taires dans la recherche de nouvelles sources de mati&egrave;res premi&egrave;res et optimise le raffinage de celles-ci.<br><br>+10% de production. <br>- 25% de vitesse de construction batiment. <br> durée 7 jours";
$lang['info'][602]['name']        = "Amiral";
$lang['info'][602]['description'] = "L'amiral de la flotte est un v&eacute;t&eacute;ran de guerre et un strat&egrave;ge redout&eacute;. M&ecirc;me lorsque le combat est acharn&eacute;, il garde le sang froid n&eacute;cessaire pour dominer la situation et est en contact permanent avec les amiraux sous ses ordres. Un empereur responsable ne saurait se passer de l'amiral de la flotte pour coordonner ses attaques et peut lui faire une telle confiance qu'il peut envoyer plus de flottes en combat.<br><br>-10% du cout des vaisseaux. <br>- 25% de vitesse de construction vaisseaux. <br>  durée 7 jours";
$lang['info'][603]['name']        = "Ingenieur";
$lang['info'][603]['description'] = "L'ing&eacute;nieur est un sp&eacute;cialiste de la gestion des constructions de defense. En temps de paix, il optimise l'efficacit&eacute; des r&eacute;seaux de defense des colonies.<br><br>-10% du cout des defense. <br>- 25% de vitesse de construction defense. <br>  durée 7 jours";
$lang['info'][604]['name']        = "Technocrate";
$lang['info'][604]['description'] = "Les guildes de technocrates sont des scientifiques au g&eacute;nie reconnu. On les trouve aux endroits o&ugrave; la technique atteint ses limites. Personne ne parviendra &agrave; d&eacute;chiffrer le cryptage d'un technocrate, sa seule pr&eacute;sence inspire les chercheurs de tout l'empire.<br><br>-10% du cout des recherches. <br>- 25% de vitesse de construction des recherches. <br>  durée 7 jours";
$lang['info'][605]['name']        = "Fondateur";
$lang['info'][605]['description'] = "Pour etre le Fondateur , il faut faire parti d'une coalition , ou regroupement de 5 membres au moins et de ce faite former une alliance , qui permet d'obtenir des avantages .<br><br>+3% de production. <br>(cumulatif tout les 5 membres)<br>  durée : infinie";
$lang['info'][606]['name']        = "genie";
$lang['info'][606]['description'] = "le genie , personnalise lui meme ces avantages . comme vous etes un génie !!!!";
...
$lang['info'][608]['description'] = "Le defenseur est membre de l'arm&eacute;e imperiale. Son ardeur dans son travail lui permet de construire une d&eacute;fense redoutable en peu de temps dans les colonies hostile.<br><br>-5% de temps de construction de la d&eacute;fense. Niveau Max. : 20";
...
$lang['info'][613]['description'] = "Le General est une v&eacute;n&eacute;rable personne qui a servit de nombreuses ann&eacute;es dans l'arm&eacute;e. Les ouvrier constructeur de vaisseaux produisent plus vite en sa pr&eacute;sence.<br><br>+5% de vitesse des vaisseaux. Niveau Max. : 10";
