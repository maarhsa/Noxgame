<script language="JavaScript" src="http://localhost/Cetus/Vues/scripts/flotten.js"></script>
<script language="JavaScript" src="http://localhost/Cetus/Vues/scripts/ocnt.js"></script>
<div id="content">
