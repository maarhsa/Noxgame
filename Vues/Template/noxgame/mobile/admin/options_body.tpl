...
<tr>
	...
	<th>{adm_opt_frames_online}<br /></th>
	<th><input name="reg_valid"{reg_valid} type="checkbox" /></th>
</tr><tr>
	<th>{adm_opt_reg_online}<br /></th>
	<th><input name="frame_valid"{frame_valid} type="checkbox" /></th>
</tr><tr>
	<th>{adm_opt_game_online}<br /></th>
	<th><input name="closed"{closed} type="checkbox" /></th>
</tr><tr>
	<th>{adm_opt_tchat_online}<br /></th>
	<th><input name="tchat_valid"{tchat_valid} type="checkbox" /></th>
</tr><tr>
	...
	<th><input name="bbcode_field"{bbcode_field} type="checkbox" /></th>
</tr>
<tr>
