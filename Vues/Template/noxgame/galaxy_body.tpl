...
<script language="JavaScript" src="http://localhost/Cetus/Vues/scripts/tw-sack.js"></script>
...
<script language="JavaScript" src="http://localhost/Cetus/Vues/scripts/wz_tooltip.js"></script>
