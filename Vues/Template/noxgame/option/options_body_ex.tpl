<center>
<br><br>
<form action="{link}options&mode=change" method="post">
<table width="519">
<tbody>
{opt_adm_frame}
<tr>
	...
	<th>{username}</th>
	<th><input name="db_character" size="20" value="{opt_usern_data}" type="hidden">{opt_usern_data}</th>
</tr><tr>
	<th>{lastpassword}</th>
	...
	<th><img src="images/Games/img/r.gif" alt="">   {attack_with_missile}</th>
	<th><input name="settings_mis"{user_settings_mis} type="checkbox" /></th>
</tr><tr>
	<th><img src="images/Games/img/s.gif" alt="">   {show_report}</th>
