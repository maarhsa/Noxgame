 ...
 */
	...
	{
	$page .= "vous n'avez pas encore la technologie Occulation";
	}
	$page .= "</td>";
	$page .= "</tr></tbody></table>";
	$page .= "</td>";
...
//		$page .= "<th><font color=\"lime\"><div id=\"time_0\"><font>". pretty_time(floor($f['fleet_end_time'] + 1 - time())) ."</font></th>";
		...
		if($f['fleet_mission'] == 25)
		{
		$page .= "<th><font color=\"red\"><div id=\"time_0\"><font>". pretty_time(floor($f['fleet_end_time'] + 432000 - time())) ."</font></th>";
		}
		else
		{
		$page .= "<th><font color=\"lime\"><div id=\"time_0\"><font>". pretty_time(floor($f['fleet_end_time'] + 1 - time())) ."</font></th>";
		...
		$page .= "<th>";
		if ($f['fleet_mess'] == 0) {
				$page .= "<form action=\"". INDEX_BASE ."retour\" method=\"post\">";
			...
			if ($f['fleet_mission'] == 1) {
				// $page .= "<form action=\"". INDEX_BASE ."fleetACS\" method=\"post\">";
				// $page .= "<input name=\"fleetid\" value=\"". $f['fleet_id'] ."\" type=\"hidden\">";
...
//		$page .= "<th>-</th>";
	...
	$page .= "<form action=\"". INDEX_BASE ."destination\" method=\"post\">";
	$page .= "<br><table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"1\">";
	$page .= "<tr height=\"20\">";
