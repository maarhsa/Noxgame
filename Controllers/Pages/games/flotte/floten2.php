 ...
 */
	...
	{
		if(empty($_POST['propuls']))
		{
			message("erreur","vous devez selectionner au moins un type de propulsion");
			if(!isset($_POST['propuls']))
			{
					message("erreur","les propulsion n'existe pas");		
			}
		}
	}
...
//FIN
	...
	if($verification_techno['hyperspace_tech']>=5)
	{
	$page .= "<input type=\"hidden\" name=\"propuls\"          value=\"". $_POST['propuls'] ."\" />\n";
	}
	$page .= "<input type=\"hidden\" name=\"speedfactor\"    value=\"". $_POST["speedfactor"] ."\" />\n";
