...
$bonusalli = 1;
	...
	$Prod[1]          = (floor(eval($ProdGrid[$BuildID]['formule']['metal'])     * $game_config['resource_multiplier'])+ $pourcentbonusmetal)*$bonusalli;
	$Prod[2]          = (floor(eval($ProdGrid[$BuildID]['formule']['crystal'])   * $game_config['resource_multiplier'])+ $pourcentbonusmetal)*$bonusalli;
	$Prod[3]          = (floor(eval($ProdGrid[$BuildID]['formule']['deuterium']) * $game_config['resource_multiplier'])+ $pourcentbonusmetal)*$bonusalli;
	$Prod[4]          = (floor(eval($ProdGrid[$BuildID]['formule']['energy'])    * $game_config['resource_multiplier']) * ( 1 + ( $CurrentUser['energy_tech'] * 0.01 ) )+ $pourcentbonusmetal)*$bonusalli;
	$BuildLevel       = "";
