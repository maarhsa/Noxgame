...
$Message = trim ( nl2br ( strip_tags ( $_POST['text'], '<br>' ) ) ); }
		...
		case 'show':
			...
			$page .= "<form action=\"". INDEX_BASE ."messages\" method=\"post\"><table>";
			$page .= "<tr>";
			$page .= "<td></td>";
		...
		default:
			...
			$page .= "</tr>";
			$page .= "<tr>";
			$page .= "	<td colspan=\"3\"><a href=\"". INDEX_BASE ."messages&mode=show&amp;messcat=100\"><font>". $lang['type'][100] ."</a></td>";
			// $page .= "	<th><font color=\"". $TitleColor[100] ."\">". $WaitingMess[100] ."</font></th>";
			// $page .= "	<th><font color=\"". $TitleColor[100] ."\">". $TotalMess[100] ."</font></th>";
			$page .= "	<td><font >". $WaitingMess[100] ."</font></td>";
			$page .= "	<td><font >". $TotalMess[100] ."</font></td>";
			$page .= "</tr>";
			for ($MessType = 0; $MessType < 100; $MessType++) {
				if ( in_array($MessType, $MessageType) ) {
					$page .= "<tr>";
					$page .= "	<td colspan=\"3\"><a href=\"". INDEX_BASE ."messages&mode=show&amp;messcat=". $MessType ." \"><font>". $lang['type'][$MessType] ."</a></td>";
					...
					$page .= "	<td><font >". $WaitingMess[$MessType] ."</font></td>";
					$page .= "	<td><font >". $TotalMess[$MessType] ."</font></td>";
					$page .= "</tr>";
				}
			}
			$page .= "</table>";
