		...
		$quoteuser = doquery($userquote, 'users',true);
			...
			if(isset($_POST['envoyer']))
			{
				...
				{							
					...
					$repondre .='<p><TEXTAREA name="messages" id="messages" rows=20 COLS=80>[quote]'.htmlspecialchars(bbcodereverse(remplacer($PostQuote['post_texte']))).'[/quote]</TEXTAREA></p>';
					$var = explode("/",$PostQuote['post_texte'],3);
					$repondre .='</td>';
					$repondre .='</tr>';
					$repondre .='<tr>';
